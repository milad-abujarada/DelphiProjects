object Form1: TForm1
  ...
  object IBDatabase1: TIBDatabase
    Connected = True
    DatabaseName = 'E:\'#1605#1606#1592#1608#1605#1577' '#1575#1604#1605#1582#1575#1586#1606' '#1608#1575#1604#1605#1576#1610#1593#1575#1578' '#1575#1604#1593#1575#1605#1577'\STORE.GDB'
    Params.Strings = (
      'user_name=sysdba'
      'password=masterkey')
    LoginPrompt = False
